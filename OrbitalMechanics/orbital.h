...
const double deg = .017453293; // PI/180.0
...
const double FLAT = .00335281967691; // 1.0/298.256421867
...
void /*Orbital::*/month_planet_names(string& month, string& planet, int month_id, int planet_id){
  if (1 <= month_id && month_id <= 12) month = months[month_id-1];
  if (1 <= planet_id && planet_id <= 9) planet = planets[planet_id-1];
}

void /*Orbital::*/displayOE(orbitalElements oe, double mu){
...
double /*Orbital::*/kepler_E (double e, double M){
...
double /*Orbital::*/kepler_H(double e, double M){
...
double /*Orbital::*/stumpS(double z){
...
double /*Orbital::*/stumpC(double z){
...
double /*Orbital::*/kepler_U(double dt, double ro, double vro, double a, double mu){
...
void /*Orbital::*/f_and_g(double &f, double &g, double x, double t, double ro, double a, double mu){
...
void /*Orbital::*/fdot_and_gdot(double &fdot, double &gdot, double x, double r, double ro, double a, double mu){
...
void /*Orbital::*/RV_from_R0V0(Vec3d &R, Vec3d &V, Vec3d R0, Vec3d V0, double t, double mu){
...
/*Orbital::*/orbitalElements /*Orbital::*/oe_from_sv(Vec3d R, Vec3d V, double mu){
...
void /*Orbital::*/sv_from_oe(Vec3d& R, Vec3d& V, orbitalElements oe, double mu){
...
double /*Orbital::*/y(double z, double r1, double r2, double A){
  // Equation 5.38
  return (r1 + r2 + A*(z*S(z) - 1.0)/sqrt(C(z)));
}

double /*Orbital::*/F(double z, double t, double r1, double r2, double A, double mu){
  // Equation 5.40
  return (pow(y(z, r1, r2, A)/C(z),1.5)*S(z) + A*sqrt(y(z, r1, r2, A)) - sqrt(mu)*t);
}

double /*Orbital::*/dFdz(double z, double r1, double r2, double A){
  // Equation 5.43
...
void /*Orbital::*/lambert(Vec3d& V1, Vec3d& V2, Vec3d R1, Vec3d R2, double t, string orb, double mu){
...
double /*Orbital::*/julian(int year, int month, int day, int hour, int min, double sec){
...
double /*Orbital::*/lst(int year, int month, int day, int hour, int min, double sec, int lon_deg, int lon_min, double lon_sec){
...
void /*Orbital::*/RV_from_observe(Vec3d& R, Vec3d& V, double rho, double rhodot, double A, double Adot, double a, double adot, double theta, double phi, double H, double f, double Re, double wE, double mu){
...
void /*Orbital::*/gauss(Vec3d& R, Vec3d& V, Vec3d& R_old, Vec3d& V_old, double dec1, double RA1, double dec2, double RA2, double dec3, double RA3, double altitude, double latitude, double LST1, double LST2, double LST3, double t1, double t2, double t3, double Re, double flat, double mu){
...
void /*Orbital::*/planet_data(double J200_oe[], double rates[], int planet_id){
...
void /*Orbital::*/planet_elements(planetElements& pe, Vec3d& R, Vec3d& V, double& jd, int planet_id, int year, int month, int day, int hour, int minute, double second, double mu){
...
void /*Orbital::*/interplanetary(Vec3d& Rp1, Vec3d& Vp1, double& jd1, Vec3d& Rp2, Vec3d& Vp2, double& jd2, Vec3d& V1, Vec3d& V2, int depart[], int arrive[], double mu){
...
double /*Orbital::*/rocket(double e1, double isp1, double e2, double isp2, double e3, double isp3, double payload, double dV){
...
double /*Orbital::*/payload(double mE1, double mp1, double isp1, double mE2, double mp2, double isp2, double Vbo){
...
double /*Orbital::*/deltaV(double mE1, double mp1, double isp1, double mE2, double mp2, double isp2, double mE3, double mp3, double isp3, double mPL){
